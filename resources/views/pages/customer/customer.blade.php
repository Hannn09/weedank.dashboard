            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="col-sm-12 ms-3">
                        <h5 class="card-title" style="font-size: 16px">Nama Customer : Handoko Sanjaya</h5>
                        <p class="card-text" style="font-size: 14px">Email : handoko@gmail.com</p>
                    ...
                    <div class="dropdown position-absolute" style="top: 15px; right: 5px;">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end rounded-3" style="min-width: 11.25rem;" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modal">Update Customer</a></li>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label for="name" class="fw-medium mb-2">Nama Customer</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="image" class="fw-medium mb-2">Foto</label>
