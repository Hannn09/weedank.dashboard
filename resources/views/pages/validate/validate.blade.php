        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-striped table-md">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center text-white fw-bold">No data available</td>
                        </tr>
                    @endforelse
                </table>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content p-3">
                    ...
                    <div class="modal-footer">
                        {{-- Button Accepted --}}
                        @if ($order->status == 1)
                            <form action="{{ route('validate.validate', $order->salesOrderCode) }}" method="POST"
                                class="d-inline">
                                @csrf
                                @method('PATCH')
